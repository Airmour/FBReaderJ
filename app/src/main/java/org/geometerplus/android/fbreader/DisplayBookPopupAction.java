...
class DisplayBookPopupAction extends FBAndroidAction {
	...
	protected void run(Object ... params) {
		...
		final ImageView coverView = bookView.findViewById(R.id.book_popup_cover);
		if (coverView != null) {
		...
		final TextView headerView = bookView.findViewById(R.id.book_popup_header_text);
		...
		final TextView descriptionView = bookView.findViewById(R.id.book_popup_description_text);
		...
		final Button downloadButton = buttonsView.findViewById(R.id.ok_button);
		...
		final Button cancelButton = buttonsView.findViewById(R.id.cancel_button);
